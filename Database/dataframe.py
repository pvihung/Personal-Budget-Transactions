...
final_records = final_df.drop(columns=['username', 'email', 'password', 'household_size', 'location_city', 'location_state', 'location_postal_code', 'location_country'])
final_records.to_csv('../dataset/final_records.csv', index=False)

final_user = final_df[['user_id', 'username', 'email', 'password', 'household_size', 'location_city', 'location_state', 'location_postal_code', 'location_country']]
